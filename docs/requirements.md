...
- Game screen: digital rain, falling katakana words, remaining time, current question count, score, difficulty, multiplier, answer input, answer button, and feedback messages.
